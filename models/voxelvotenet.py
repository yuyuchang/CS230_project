...
class VoxelVoteNet(nn.Module):
    r"""
        ...
        ----------
        num_class: int
    i        Number of semantics classes to predict over -- size of softmax classifier
        num_heading_bin: int
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
        ...
        self.backbone_net = VoxelPointnet2Backbone(input_feature_dim=self.input_feature_dim)
